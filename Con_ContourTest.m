...
max(max(C))
xlswrite('qianx12.xlsx',X_R)
xlswrite('qiany12.xlsx',Y_R)
xlswrite('qianc12.xlsx',C)
...
% global ProbotY
% 
% ProbotX=1500;ProbotY=-200; %起点坐标
% ProbotXD=1500;ProbotYD=-200; %对照组起点坐标
% %80 30
% Nstep=1000; %控制步数，以免死循环
% Rpx=zeros(1,Nstep); 
% Rpy=zeros(1,Nstep);
% RpxD=zeros(1,Nstep); 
% RpyD=zeros(1,Nstep);
...
% ii=0;%V用于判断当前行动模式
% ddx=30;%NDG中每一步在X轴上的距离
% ddy=15;%NDG中每一步在Y轴上的距离
% s1=1;%Six中1逆时针2顺时针
% s2=6000;%Six中用于判断
% C4=6;%Six中n-1点浓度
% C5=5;%Six中n-2点浓度
